...
const NavBar = () => {
  ...
  return (
    <div className="sticky top-0 z-[999] right-0">
      <nav className="relative flex  z-[999] items-center justify-between px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 py-4 md:py-6 bg-white font-sans shadow-lg">
        {/* Logo Section */}
